...
- `SHOPIFY_INVENTORY_API_VERSION` — Inventory Helper transfer API version; default `2026-07`
      ...
      - name: Deploy
        run: |
          gcloud run deploy order-collector \
            ...
            --port 8080 \
            --allow-unauthenticated \
            --set-env-vars BASE_URL=${{ secrets.BASE_URL }},SHOPIFY_CLIENT_ID=${{ secrets.SHOPIFY_CLIENT_ID }},SHOPIFY_CLIENT_SECRET=${{ secrets.SHOPIFY_CLIENT_SECRET }},SHOPIFY_STORE_KEYS=${{ secrets.SHOPIFY_STORE_KEYS }},SHOPIFY_OAUTH_SCOPES=${{ secrets.SHOPIFY_OAUTH_SCOPES }},SHOPIFY_API_VERSION=2025-01,SHOPIFY_INVENTORY_API_VERSION=2026-07
```
